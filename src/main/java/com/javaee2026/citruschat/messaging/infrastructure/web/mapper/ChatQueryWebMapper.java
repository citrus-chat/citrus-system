...
public final class ChatQueryWebMapper {
	...
	// public static ChatRoomSummaryResponse
	// toChatRoomSummaryResponse(ChatRoomSummaryResult result) {
	// return new ChatRoomSummaryResponse(result.id(), result.name(),
	// result.type().name(), result.createdAt(),
	// result.updatedAt());
	// }
