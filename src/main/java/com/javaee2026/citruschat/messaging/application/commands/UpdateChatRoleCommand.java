...
public record UpdateChatRoleCommand(ChatRoomId chatRoomId, RoleId roleId, UserId requesterUserId, String name,
		Integer priority, List<PermissionId> permissionIds) {
}
