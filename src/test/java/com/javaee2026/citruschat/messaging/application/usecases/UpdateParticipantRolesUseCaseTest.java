...
// import
// com.javaee2026.citruschat.messaging.application.commands.UpdateParticipantRolesCommand;
// import
// com.javaee2026.citruschat.messaging.application.exceptions.ChatParticipantRolesException;
// import
...
// import
// com.javaee2026.citruschat.messaging.application.results.UpdateParticipantRolesResult;
...
// @BeforeEach
// void setUp() {
// useCase = new UpdateParticipantRolesUseCase(chatRoomRepository,
// chatParticipantRepository,
// chatPermissionRepository, authorizationService());
// chatRoomId = new
// ChatRoomId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000001"));
// targetParticipantId = new
// ParticipantId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000002"));
// requesterParticipantId = new
// ParticipantId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000003"));
// otherParticipantId = new
// ParticipantId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000004"));
// creatorUserId = new
// UserId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000005"));
// requesterUserId = new
// UserId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000006"));
// targetUserId = new
// UserId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000007"));
// ownerRoleId = new
// RoleId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000008"));
// adminRoleId = new
// RoleId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000009"));
// memberRoleId = new
// RoleId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000010"));
// manageRolesPermission = permission("aaaaaaaa-0000-0000-0000-000000000011",
// ChatPermissionList.CAN_MODIFY_ROLE);
// sendMessagePermission = permission("aaaaaaaa-0000-0000-0000-000000000012",
// ChatPermissionList.CAN_SEND_MESSAGE);
// ownerRole = role(ownerRoleId, "OWNER", Set.of(manageRolesPermission,
// sendMessagePermission), 100);
// adminRole = role(adminRoleId, "ADMIN", Set.of(manageRolesPermission,
// sendMessagePermission), 80);
...
// UpdateParticipantRolesCommand command = command(requesterUserId,
// List.of(memberRoleId, memberRoleId));

// ChatParticipantRolesException exception =
// assertThrows(ChatParticipantRolesException.class,
...
// ChatParticipant target = participant(targetParticipantId, targetUserId,
...
// when(chatParticipantRepository.findActiveByChatRoomIdAndParticipantId(chatRoomId,
// targetParticipantId))
...
// verify(chatParticipantRepository, never()).replaceParticipantRoles(any(),
// any(), any());
// }
...
// ChatParticipant requester = participant(requesterParticipantId,
// requesterUserId, List.of(memberRoleId));
// ChatParticipant target = participant(targetParticipantId, targetUserId,
// List.of(memberRoleId));
...
// ChatParticipant requester = participant(requesterParticipantId,
// creatorUserId, List.of(memberRoleId));
// ChatParticipant target = participant(targetParticipantId, targetUserId,
// List.of(memberRoleId));
// ChatRoom room = groupRoom(creatorUserId, List.of(requester, target));
...
// verify(chatParticipantRepository).replaceParticipantRoles(chatRoomId,
// targetParticipantId,
// List.of(adminRoleId));
// }
...
// ChatParticipant requester = participant(requesterParticipantId,
// requesterUserId, List.of(adminRoleId));
// ChatParticipant target = participant(targetParticipantId, targetUserId,
// List.of(memberRoleId));
// ChatRoom room = groupRoom(creatorUserId, List.of(requester, target));
...
// ChatParticipant targetAndRequester = participant(targetParticipantId,
// requesterUserId, List.of(adminRoleId));
...
// RoleId unknownRoleId = new
// RoleId(UUID.fromString("aaaaaaaa-0000-0000-0000-000000000013"));
// ChatParticipant requester = participant(requesterParticipantId,
// requesterUserId, List.of(adminRoleId));
// ChatParticipant target = participant(targetParticipantId, targetUserId,
// List.of(memberRoleId));
...
// UpdateParticipantRolesResult result =
// useCase.execute(command(requesterUserId, List.of(adminRoleId)));
...
// assertEquals(Set.of(manageRolesPermission, sendMessagePermission),
// result.permissions());
// verify(chatParticipantRepository).replaceParticipantRoles(chatRoomId,
// targetParticipantId,
// List.of(adminRoleId));
// verify(chatPermissionRepository).findPermissionsByChatRoomAndParticipant(chatRoomId,
// targetParticipantId);
// }

// private void stubParticipants(ChatRoom room, ChatParticipant target,
...
// private UpdateParticipantRolesCommand command(UserId requester, List<RoleId>
// roleIds) {
// return new UpdateParticipantRolesCommand(chatRoomId, targetParticipantId,
// requester, roleIds);
// }

// private ChatRoom groupRoom(UserId createdBy, List<ChatParticipant>
// participants) {
// return new ChatRoom(chatRoomId, ChatRoomType.GROUP, "Group", createdBy,
